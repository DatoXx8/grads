...
pub const Dense = struct {
    ...
    pub fn alloc(allocator: Allocator, size_in: u32, size_out: u32, context: ClContext) !Dense {
        ...
        return .{
            .size_in = size_in,
            .size_out = size_out,
            .weights = try Tensor.alloc(allocator, 1, 1, size_in, size_out, context, 1),
            .weights_g = try Tensor.alloc(allocator, 1, 1, size_in, size_out, context, size_in + size_out + 1),
            .biases = try Tensor.alloc(allocator, 1, 1, 1, size_out, context, 1),
            .biases_g = try Tensor.alloc(allocator, 1, 1, 1, size_out, context, 1),
            ...
            .temp_full = try Tensor.allocIntermediary(allocator, 1, 1, size_in, size_out, size_in + size_out),
        };
    }
    ...
    pub fn forward(this: *@This(), in: *Tensor, out: *Tensor) !void {
        ...
        this.weights.moveResize(1, 1, this.size_in, this.size_in);
...
pub const Convolution = struct {
    ...
    inline fn sizeNew(dim_size: u32, kernel_size: u32, kernel_stride: u32, kernel_padding: u32) u32 {
    ...
    pub fn alloc(
        ...
        return .{
            ...
            .weights = try Tensor.alloc(allocator, filters, z_in, kernel_size, kernel_size, context, 1),
            .weights_g = try Tensor.alloc(allocator, filters, z_in, kernel_size, kernel_size, context, 3 * filters * y_out * x_out),
            .biases = try Tensor.alloc(allocator, filters, 1, 1, 1, context, 1),
...
pub const Reduce = struct {
    ...
    kernel_stride: u32,
    t: Type,
    inline fn sizeNew(dim_size: u32, kernel_size: u32, kernel_stride: u32) u32 {
        assert(dim_size >= kernel_size);
