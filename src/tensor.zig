...
pub const Op = struct {
    ...
    pub fn debug(this: *const @This(), comptime padding: u32, comptime offset: u32, name: ?[]const u8) void {
        ...
        switch (this.type) {
            .unary_add => std.debug.print("U add ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" {d}\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .unary_subtract => std.debug.print("U sub ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" {d}\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .unary_multiply => std.debug.print("U mul ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" {d}\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .unary_divide => std.debug.print("U div ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" {d}\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .unary_exp => std.debug.print("U exp ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .unary_log => std.debug.print("U log ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .unary_square => std.debug.print("U sqr ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .unary_sqrt => std.debug.print("U sqt ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .unary_reciprocal => std.debug.print("U rec ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .unary_max => std.debug.print("U max ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" {d}\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .unary_min => std.debug.print("U min ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" {d}\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .unary_set => std.debug.print("U set ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" {d}\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .unary_random => std.debug.print("U rng ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .unary_tanh => std.debug.print("U tan ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .unary_absolute => std.debug.print("U abs ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .unary_sign => std.debug.print("U sgn ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .binary_add => std.debug.print("B add ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .binary_subtract => std.debug.print("B sub ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .binary_multiply => std.debug.print("B mul ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .binary_divide => std.debug.print("B div ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .binary_max => std.debug.print("B max ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .binary_min => std.debug.print("B min ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .binary_set => std.debug.print("B set ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .linary_add => std.debug.print("L add ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .linary_subtract => std.debug.print("L sub ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .linary_multiply => std.debug.print("L mul ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .linary_divide => std.debug.print("L div ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .linary_max => std.debug.print("L max ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .linary_min => std.debug.print("L min ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .linary_set => std.debug.print("L set ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .reduce_sum => std.debug.print("R sum ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .reduce_max => std.debug.print("R max ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .reduce_min => std.debug.print("R min ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
            ...
            .reduce_avg => std.debug.print("R avg ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\" ({d} {d} {d} {d}) [{d} {d} {d} {d} = {d}] \"{s}\"\n", .{
                this.out.a_size,
                this.out.z_size,
                this.out.y_size,
                this.out.x_size,
...
pub const Tensor = struct {
    ...
    pub fn unarySubtract(this: *@This(), allocator: anytype, u_var: f32) !void {
        assert(!math.isNan(u_var));
        assert(!math.isInf(u_var));
        try this.linearized.append(allocator, &.{
            .out = this.buffer,
    ...
    pub fn unaryMultiply(this: *@This(), allocator: anytype, u_var: f32) !void {
        assert(!math.isNan(u_var));
        assert(!math.isInf(u_var));
        try this.linearized.append(allocator, &.{
            .out = this.buffer,
    ...
    pub fn unaryDivide(this: *@This(), allocator: anytype, u_var: f32) !void {
        assert(!math.isNan(u_var));
        assert(!math.isInf(u_var));
        try this.linearized.append(allocator, &.{
            .out = this.buffer,
    ...
    pub fn unaryExp(this: *@This(), allocator: anytype) !void {
        try this.linearized.append(allocator, &.{
            .out = this.buffer,
            .in = this.buffer,
            .type = .unary_exp,
    ...
    pub fn unaryLog(this: *@This(), allocator: anytype) !void {
        try this.linearized.append(allocator, &.{
            .out = this.buffer,
            .in = this.buffer,
            .type = .unary_log,
    ...
    pub fn unarySquare(this: *@This(), allocator: anytype) !void {
        try this.linearized.append(allocator, &.{
            .out = this.buffer,
            .in = this.buffer,
            .type = .unary_square,
    ...
    pub fn unarySqrt(this: *@This(), allocator: anytype) !void {
        try this.linearized.append(allocator, &.{
            .out = this.buffer,
            .in = this.buffer,
            .type = .unary_sqrt,
    ...
    pub fn unaryReciprocal(this: *@This(), allocator: anytype) !void {
        try this.linearized.append(allocator, &.{
            .out = this.buffer,
            .in = this.buffer,
    ...
    pub fn unaryMax(this: *@This(), allocator: anytype, u_var: f32) !void {
        assert(!math.isNan(u_var));
        assert(!math.isInf(u_var));
        try this.linearized.append(allocator, &.{
            .out = this.buffer,
    ...
    pub fn unaryMin(this: *@This(), allocator: anytype, u_var: f32) !void {
        assert(!math.isNan(u_var));
        assert(!math.isInf(u_var));
        try this.linearized.append(allocator, &.{
            .out = this.buffer,
    ...
    pub fn unarySet(this: *@This(), allocator: anytype, u_var: f32) !void {
        assert(!math.isNan(u_var));
        assert(!math.isInf(u_var));
        try this.linearized.append(allocator, &.{
            .out = this.buffer,
    ...
    pub fn unaryRandom(this: *@This(), allocator: anytype) !void {
        try this.linearized.append(allocator, &.{
            .out = this.buffer,
            .in = this.buffer,
            .type = .unary_random,
    ...
    pub fn unaryTanh(this: *@This(), allocator: anytype) !void {
        try this.linearized.append(allocator, &.{
            .out = this.buffer,
            .in = this.buffer,
            .type = .unary_tanh,
    ...
    pub fn unaryAbsolute(this: *@This(), allocator: anytype) !void {
        try this.linearized.append(allocator, &.{
            .out = this.buffer,
            .in = this.buffer,
            .type = .unary_absolute,
    ...
    pub fn unarySign(this: *@This(), allocator: anytype) !void {
        try this.linearized.append(allocator, &.{
            .out = this.buffer,
            .in = this.buffer,
            .type = .unary_sign,
    ...
    pub fn binaryAdd(this: *@This(), allocator: anytype, source: *@This()) !void {
    ...
    pub fn binarySubtract(this: *@This(), allocator: anytype, source: *@This()) !void {
        assert(this.buffer.a_size == source.buffer.a_size);
        assert(this.buffer.z_size == source.buffer.z_size);
        assert(this.buffer.y_size == source.buffer.y_size);
        assert(this.buffer.x_size == source.buffer.x_size);
    ...
    pub fn binaryMultiply(this: *@This(), allocator: anytype, source: *@This()) !void {
        assert(this.buffer.a_size == source.buffer.a_size);
        assert(this.buffer.z_size == source.buffer.z_size);
        assert(this.buffer.y_size == source.buffer.y_size);
        assert(this.buffer.x_size == source.buffer.x_size);
    ...
    pub fn binaryDivide(this: *@This(), allocator: anytype, source: *@This()) !void {
        assert(this.buffer.a_size == source.buffer.a_size);
        assert(this.buffer.z_size == source.buffer.z_size);
        assert(this.buffer.y_size == source.buffer.y_size);
        assert(this.buffer.x_size == source.buffer.x_size);
    ...
    pub fn binaryMax(this: *@This(), allocator: anytype, source: *@This()) !void {
        assert(this.buffer.a_size == source.buffer.a_size);
        assert(this.buffer.z_size == source.buffer.z_size);
        assert(this.buffer.y_size == source.buffer.y_size);
        assert(this.buffer.x_size == source.buffer.x_size);
    ...
    pub fn binaryMin(this: *@This(), allocator: anytype, source: *@This()) !void {
        assert(this.buffer.a_size == source.buffer.a_size);
        assert(this.buffer.z_size == source.buffer.z_size);
        assert(this.buffer.y_size == source.buffer.y_size);
        assert(this.buffer.x_size == source.buffer.x_size);
    ...
    pub fn binarySet(this: *@This(), allocator: anytype, source: *@This()) !void {
        assert(this.buffer.a_size == source.buffer.a_size);
        assert(this.buffer.z_size == source.buffer.z_size);
        assert(this.buffer.y_size == source.buffer.y_size);
        assert(this.buffer.x_size == source.buffer.x_size);
    ...
    pub fn linaryAdd(this: *@This(), allocator: anytype, source: *@This()) !void {
    ...
    pub fn linarySubtract(this: *@This(), allocator: anytype, source: *@This()) !void {
        assert(source.buffer.a_size == 1);
        assert(source.buffer.z_size == 1);
        assert(source.buffer.y_size == 1);
        assert(source.buffer.x_size == 1);
    ...
    pub fn linaryMultiply(this: *@This(), allocator: anytype, source: *@This()) !void {
        assert(source.buffer.a_size == 1);
        assert(source.buffer.z_size == 1);
        assert(source.buffer.y_size == 1);
        assert(source.buffer.x_size == 1);
    ...
    pub fn linaryDivide(this: *@This(), allocator: anytype, source: *@This()) !void {
        assert(source.buffer.a_size == 1);
        assert(source.buffer.z_size == 1);
        assert(source.buffer.y_size == 1);
        assert(source.buffer.x_size == 1);
    ...
    pub fn linaryMax(this: *@This(), allocator: anytype, source: *@This()) !void {
        assert(source.buffer.a_size == 1);
        assert(source.buffer.z_size == 1);
        assert(source.buffer.y_size == 1);
        assert(source.buffer.x_size == 1);
    ...
    pub fn linaryMin(this: *@This(), allocator: anytype, source: *@This()) !void {
        assert(source.buffer.a_size == 1);
        assert(source.buffer.z_size == 1);
        assert(source.buffer.y_size == 1);
        assert(source.buffer.x_size == 1);
    ...
    pub fn linarySet(this: *@This(), allocator: anytype, source: *@This()) !void {
        assert(source.buffer.a_size == 1);
        assert(source.buffer.z_size == 1);
        assert(source.buffer.y_size == 1);
        assert(source.buffer.x_size == 1);
    ...
    pub fn reduceSum(this: *@This(), allocator: anytype, source: *@This()) !void {
    ...
    pub fn reduceMax(this: *@This(), allocator: anytype, source: *@This()) !void {
        assert(this.buffer.a_size == 1);
        assert(this.buffer.z_size == 1);
        assert(this.buffer.y_size == 1);
        assert(this.buffer.x_size == 1);
    ...
    pub fn reduceMin(this: *@This(), allocator: anytype, source: *@This()) !void {
        assert(this.buffer.a_size == 1);
        assert(this.buffer.z_size == 1);
        assert(this.buffer.y_size == 1);
        assert(this.buffer.x_size == 1);
    ...
    pub fn reduceAvg(this: *@This(), allocator: anytype, source: *@This()) !void {
        assert(this.buffer.a_size == 1);
        assert(this.buffer.z_size == 1);
        assert(this.buffer.y_size == 1);
        assert(this.buffer.x_size == 1);
