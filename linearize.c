    ...
    case operation_unary: {
        ...
        case unary_add: {
            printf("U add {%lu, %lu, %lu, %lu} %lu [%lu, %lu, %lu, %lu] %lf %s\n", simple->buffer_out.sze_a,
                   simple->buffer_out.sze_z, simple->buffer_out.sze_y, simple->buffer_out.sze_x, simple->buffer_out.off,
                   simple->buffer_out.off_a, simple->buffer_out.off_z, simple->buffer_out.off_y,
                   simple->buffer_out.off_x, simple->var_unary, simple->buffer_out.name);
            break;
        }
        case unary_subtract: {
        ...
        case unary_exp: {
            printf("U exp {%lu, %lu, %lu, %lu} %lu [%lu, %lu, %lu, %lu] %s\n", simple->buffer_out.sze_a,
                   simple->buffer_out.sze_z, simple->buffer_out.sze_y, simple->buffer_out.sze_x, simple->buffer_out.off,
                   simple->buffer_out.off_a, simple->buffer_out.off_z, simple->buffer_out.off_y,
                   simple->buffer_out.off_x, simple->buffer_out.name);
            break;
        }
        case unary_log: {
    ...
    case operation_binary: {
        ...
        case binary_add: {
            printf(
                ...
                simple->buffer_out.sze_a, simple->buffer_out.sze_z, simple->buffer_out.sze_y, simple->buffer_out.sze_x,
                simple->buffer_out.off, simple->buffer_out.off_a, simple->buffer_out.off_z, simple->buffer_out.off_y,
                simple->buffer_out.off_x, simple->buffer_in.sze_a, simple->buffer_in.sze_z, simple->buffer_in.sze_y,
                simple->buffer_in.sze_x, simple->buffer_in.off, simple->buffer_in.off_a, simple->buffer_in.off_z,
                simple->buffer_in.off_y, simple->buffer_in.off_x, simple->buffer_out.name, simple->buffer_in.name);
            break;
        }
...
void simple_op_realize(simple_op_t *simple) {
    ...
    case operation_reduce: {
        ...
        case reduce_avg: {
            ...
            SIMPLE_AT(simple->buffer_out, 0, 0, 0, 0) = temp / (simple->buffer_in.sze_x * simple->buffer_in.sze_y *
                                                                simple->buffer_in.sze_z * simple->buffer_in.sze_a);
            break;
        }
        case reduce_min: {
            double temp = INFINITY;
